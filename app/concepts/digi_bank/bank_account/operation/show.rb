    ...
    module Operation
      class Show < ::BaseOperation
        ...
        def fetch_money_transaction(ctx, bank_account:, **)
          ctx[:money_transactions] = bank_account.all_money_transactions
        end
        ...
        def paginate_money_transactions(ctx, params:, money_transactions:, current_user:, **)
          vars = { page: params[Pagy::DEFAULT[:page_param]] }
        ...
        def set_operation_result(ctx, decorated_bank_account:, decorated_and_paginated_money_transactions:, pagy_cursor:, **)
          ctx[:operation_result] = {
            bank_account: decorated_bank_account,
            money_transactions: decorated_and_paginated_money_transactions,
            pagy_cursor: pagy_cursor
          }
        end
      end
    end
